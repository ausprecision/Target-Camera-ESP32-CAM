...
void spiffs_init(){
  ...
  if (!SPIFFS.exists("/wifichan.ini")) { Serial.println("spiffs_files: /wifichan.ini does not exist, creating file"); file = SPIFFS.open("/wifichan.ini", FILE_WRITE); file.println("4"); file.close(); }
  ...
  if (!SPIFFS.exists("/wifiprot.ini")) { Serial.println("spiffs_files: /wifiprot.ini does not exist, creating file"); file = SPIFFS.open("/wifiprot.ini", FILE_WRITE); file.println("LR"); file.close(); }
