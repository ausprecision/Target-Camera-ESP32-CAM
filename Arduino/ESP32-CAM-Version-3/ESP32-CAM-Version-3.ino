...
void onTelnetInput(String str) {
  ...
  else if (str.indexOf("camera set xclk ") >=0) { res = s->set_xclk(s, LEDC_TIMER_0, str.substring(16).toInt()); if (res == 0) { receivecfg("/camera/cfg-xclx.txt",str.substring(16),"cameraserver: set_xclk " + str.substring(16) + " (OK!)", diagCfgXCLK);  telnet.println("");       telnet.print(str.substring(16));       telnet.println(" OK");       telnet.println("");       telnet.print("C:\\>");     }     else     {       telnet.println("cameraserver: set_xclk (FAILED!)");       telnet.println(""); telnet.print("C:\\>");     }   }  
  else if (str.indexOf("camera set aec2 ") >=0) { res = s->set_aec2(s, str.substring(16).toInt());  if (res == 0)  {  receivecfg("/camera/cfg-aec2.txt",str.substring(16),"cameraserver: set_aec2 " + str.substring(16) + " (OK!)", diagCfgAEC2);  telnet.println("");  telnet.print(str.substring(16));       telnet.println(" OK");       telnet.println("");       telnet.print ("C:\\>");     }    else     {       telnet.println("cameraserver: set_xclk (FAILED!)");       telnet.println("");       telnet.print("C:\\>");     }   }  
